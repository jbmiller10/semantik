...
def test_utf8_boundary():
    ...
    test_cases = [
        ...
        ("Café".encode('utf-8'), 3, 3, "Before é"),
        ("Hello 中文".encode('utf-8'), 8, 6, "Before Chinese"),
        ("Test 🎉".encode('utf-8'), 6, 5, "Before emoji"),
    ]
