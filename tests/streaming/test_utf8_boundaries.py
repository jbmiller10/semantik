...
class TestUTF8BoundaryHandling:
    ...
    def test_2byte_utf8_boundary(self):
        ...
        data = "Café".encode('utf-8')  # C a f é -> C a f [C3 A9]
    ...
    def test_3byte_utf8_boundary(self):
        ...
        # Find where "中" starts
        hello_len = len("Hello".encode('utf-8'))  # 5 bytes
    ...
    def test_4byte_utf8_boundary(self):
        ...
        # Emoji 🎉 (F0 9F 8E 89)
        data = "Party🎉Time".encode('utf-8')
        
        party_len = len("Party".encode('utf-8'))  # 5 bytes
    ...
    def test_streaming_window_utf8_safety(self):
        ...
        hello_len = len("Hello ".encode('utf-8'))
