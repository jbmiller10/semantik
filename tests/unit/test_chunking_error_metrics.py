...
class TestChunkingErrorMetrics:
    ...
    def test_metric_initialization(self) -> None:
        ...
        assert chunking_errors_total._name == "chunking_errors_total"
        ...
        assert set(chunking_error_recovery_attempts._labelnames) == {
        ...
        assert set(chunking_document_processing_duration._labelnames) == {
    ...
    def test_histogram_buckets(self) -> None:
        ...
        memory_buckets = chunking_memory_usage_bytes._buckets
