...
class TestChunkingStrategyRegistry:
    ...
    def test_get_strategy_definition_valid(self) -> None:
    ...
    def test_get_strategy_definition_fixed_size(self) -> None:
    ...
    def test_get_strategy_definition_semantic(self) -> None:
    ...
    def test_get_recommended_strategy_pdf_files(self) -> None:
    ...
    def test_get_recommended_strategy_text_files(self) -> None:
    ...
    def test_get_recommended_strategy_mixed_files(self) -> None:
    ...
    def test_get_recommended_strategy_unknown_files(self) -> None:
    ...
    def test_get_recommended_strategy_empty_list(self) -> None:
    ...
    def test_get_recommended_strategy_code_files(self) -> None:
    ...
    def test_get_recommended_strategy_structured_documents(self) -> None:
    ...
    def test_get_recommended_strategy_logs(self) -> None:
    ...
    def test_strategy_performance_characteristics(self) -> None:
    ...
    def test_strategy_best_for_completeness(self) -> None:
    ...
    def test_hybrid_strategy_characteristics(self) -> None:
    ...
    def test_sliding_window_strategy_characteristics(self) -> None:
    ...
    def test_document_structure_strategy_characteristics(self) -> None:
    ...
    def test_recursive_strategy_characteristics(self) -> None:
