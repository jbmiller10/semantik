...
""",
            ...
            "very_long": " ".join([f"Sentence number {i} contains information about topic {i % 10}." for i in range(1000)]),
        }
    ...
    def test_build_hierarchy_info(self):
        ...
        child_node.relationships = {
            "1": MagicMock(node_id="parent_1")  # Parent relationship
        }
        ...
        grandchild_node.relationships = {
            "1": MagicMock(node_id="child_1")  # Parent relationship
        }
    ...
    def test_uneven_hierarchies(self, sample_texts):
        ...
        mixed_text = (
            "Short section. " +  # Fits in smallest chunk
            "Medium section with more content that needs a bigger chunk. " * 10 +  # Needs medium chunk
            "Very long section with extensive content. " * 100  # Needs all levels
        )
