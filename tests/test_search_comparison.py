...
def test_original_api():
    ...
    try:
        response = httpx.get("http://localhost:8000/search", params={"q": "machine learning transformers", "k": 5})
...
def test_optimized_api():
    ...
    try:
        ...
        response = httpx.post(
            ...
            json={"query": "machine learning transformers", "k": 5, "search_type": "semantic"},
            timeout=30.0,
        )
