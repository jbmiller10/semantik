...
async def test_directory_scan_preview_success(async_client: AsyncClient, test_user_headers: dict[str, str]) -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        expected_files = ["document1.pdf", "document2.docx", "readme.txt", 
                         "presentation.pptx", "email.eml", "notes.md", "page.html"]
...
@pytest.mark.asyncio
async def test_directory_scan_preview_with_patterns(async_client: AsyncClient, test_user_headers: dict[str, str]) -> None:
...
@pytest.mark.asyncio
async def test_directory_scan_preview_nonexistent_path(async_client: AsyncClient, test_user_headers: dict[str, str]) -> None:
...
@pytest.mark.asyncio
async def test_directory_scan_preview_file_instead_of_directory(async_client: AsyncClient, test_user_headers: dict[str, str]) -> None:
...
@pytest.mark.asyncio
async def test_directory_scan_preview_invalid_scan_id(async_client: AsyncClient, test_user_headers: dict[str, str]) -> None:
...
@pytest.mark.asyncio
async def test_directory_scan_preview_relative_path(async_client: AsyncClient, test_user_headers: dict[str, str]) -> None:
...
@pytest.mark.asyncio
async def test_directory_scan_websocket_connection(async_client: AsyncClient, test_user_headers: dict[str, str]) -> None:
