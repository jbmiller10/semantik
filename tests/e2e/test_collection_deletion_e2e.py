...
class TestCollectionDeletionE2E:
    ...
    def test_delete_collection_from_ui(self, page: Page, test_collection_with_data):
    ...
    def test_delete_collection_keyboard_shortcut(self, page: Page, test_collection_with_data):
    ...
    async def test_delete_collection_database_cleanup(
        ...
        ops_result = await db_session.execute(
            select(Operation).where(Operation.collection_id == collection_id)
        )
        assert len(ops_result.scalars().all()) == 0
        
    def test_delete_collection_permission_denied(self, page: Page, other_user_collection):
    ...
    def test_delete_collection_with_active_operation(self, page: Page, collection_with_active_operation):
    ...
    def test_delete_collection_cancel(self, page: Page, test_collection_with_data):
    ...
    def test_delete_multiple_collections_sequentially(self, page: Page, multiple_test_collections):
...
def test_collection_with_data(create_test_collection_with_documents):
    ...
    return create_test_collection_with_documents(
...
def other_user_collection(create_collection_for_other_user):
    ...
    return create_collection_for_other_user(
...
def collection_with_active_operation(create_collection_with_active_operation):
    ...
    return create_collection_with_active_operation(
        name="Collection with Active Op",
...
def multiple_test_collections(create_test_collection_with_documents):
    ...
    collections = []
    for i in range(3):
        collection = create_test_collection_with_documents(
