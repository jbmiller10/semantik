  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="flex-shrink-0 flex items-center gap-2">
            ...
            {collection.error_count > 0 && (
              <span className="badge bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 gap-1">
                <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                </svg>
                {collection.error_count} {collection.error_count === 1 ? 'error' : 'errors'}
              </span>
            )}
          </div>
        </div>
        ...
        {collection.status_message && collection.status === 'error' && (
          <div className="mb-4 p-3 rounded-lg border bg-error/10 border-error/20">
