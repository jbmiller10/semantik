        ...
        {showNoneOption && (
          <button
            ...
            className={`
              ...
              ${
                selectedType === 'none'
                  ? 'border-signal-500 bg-signal-500/10 ring-2 ring-signal-500/20'
                  : 'border-void-700 bg-void-800 hover:border-void-600 hover:bg-void-700'
              }
          ...
          >
            ...
            <div className={`mb-2 ${selectedType === 'none' ? 'text-signal-400' : 'text-gray-500'}`}>
              <Ban className="h-6 w-6" />
            </div>
            <span className={`text-sm font-medium ${selectedType === 'none' ? 'text-signal-300' : 'text-gray-200'}`}>
              None
            </span>
            <span className={`text-xs mt-1 text-center ${selectedType === 'none' ? 'text-signal-400' : 'text-gray-500'}`}>
              Add later
            </span>
          </button>
        )}
            ...
            >
              ...
              <span
                className={`text-sm font-medium ${
                  isSelected ? 'text-signal-300' : 'text-gray-200'
                }`}
              >
                {definition.name}
              </span>
              ...
              <span
                className={`text-xs mt-1 text-center ${
                  isSelected ? 'text-signal-400' : 'text-gray-500'
                }`}
              >
