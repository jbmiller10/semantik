...
function CreateJobForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addToast({ type: 'success', message: 'Job created successfully' });
      setActiveTab('jobs');
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-6">
          {/* Collection Name - moved to top like original */}
          <div>
          ...
          {/* Model Selection - Always visible like original */}
          <div>
          ...
          {/* Chunk Settings - 2 column grid like original */}
        ...
        <div className="flex justify-end space-x-3 pt-6 border-t">
          ...
          <button
            type="submit"
            disabled={creating || !scanResult || !collectionName}
