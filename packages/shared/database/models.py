...
class CollectionPermission(Base):
    ...
    permission = Column(Enum(PermissionType, name="permission_type"), nullable=False)
    created_at = Column(DateTime(timezone=True), nullable=False, default=func.now())
...
class Operation(Base):
    ...
    type = Column(Enum(OperationType, name="operation_type", native_enum=True, create_constraint=False), nullable=False, index=True)
