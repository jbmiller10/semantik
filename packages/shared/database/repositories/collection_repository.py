...
class CollectionRepository:
    ...
    async def create(
        ...
        Args:
            ...
            chunking_strategy: Chunking strategy to use (character, recursive, markdown, semantic, hierarchical, hybrid)
            chunking_params: Strategy-specific parameters for chunking
