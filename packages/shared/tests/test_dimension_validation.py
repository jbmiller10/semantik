...
class TestDimensionValidation:
    ...
    def test_validate_dimension_compatibility_success(self):
    ...
    def test_validate_dimension_compatibility_failure(self):
    ...
    def test_validate_embedding_dimensions_success(self):
    ...
    def test_validate_embedding_dimensions_empty_list(self):
