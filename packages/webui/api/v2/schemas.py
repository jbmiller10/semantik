...
class CollectionSearchRequest(BaseModel):
    ...
    hyde_enabled: bool | None = Field(default=None, description="Enable HyDE (Hypothetical Document Embeddings)")
...
class CollectionSearchResponse(BaseModel):
    ...
    hyde_hypothetical_doc: str | None = Field(None, description="The hypothetical document generated by HyDE")
