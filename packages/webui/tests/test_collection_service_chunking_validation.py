...
@pytest.fixture
def collection_service(mock_db_session, mock_collection_repo, mock_operation_repo, mock_document_repo):
...
class TestCreateCollectionValidation:
    ...
    @pytest.mark.asyncio
    async def test_valid_chunking_strategy_accepted(self, collection_service, mock_collection_repo):
    ...
    @pytest.mark.asyncio
    async def test_invalid_chunking_strategy_rejected(self, collection_service):
    ...
    @pytest.mark.asyncio
    async def test_chunking_config_without_strategy_rejected(self, collection_service):
    ...
    @pytest.mark.asyncio
    async def test_invalid_chunking_config_rejected(self, collection_service):
    ...
    @pytest.mark.asyncio
    async def test_strategy_name_normalization(self, collection_service, mock_collection_repo):
...
class TestUpdateCollectionValidation:
    ...
    @pytest.mark.asyncio
    async def test_valid_strategy_update_accepted(self, collection_service, mock_collection_repo, mock_db_session):
    ...
    @pytest.mark.asyncio
    async def test_invalid_strategy_update_rejected(self, collection_service, mock_collection_repo):
    ...
    @pytest.mark.asyncio
    async def test_config_update_without_strategy_rejected(self, collection_service, mock_collection_repo):
