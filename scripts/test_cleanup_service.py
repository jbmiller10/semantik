...
def test_cleanup_dry_run():
    ...
    with tempfile.NamedTemporaryFile(mode="wb", delete=False) as f:
        ...
        test_files = ["/data/documents/file1.pdf", "/data/documents/file2.docx", "/data/documents/file3.txt"]
...
def test_tracker_integration():
    ...
    try:
        ...
        tracker.tracking_data["files"] = {
            "/data/old/removed1.pdf": {"doc_id": "test_doc_1", "hash": "abc123", "last_seen": "2024-01-01T00:00:00"},
            "/data/old/removed2.docx": {"doc_id": "test_doc_2", "hash": "def456", "last_seen": "2024-01-01T00:00:00"},
            "/data/current/exists.txt": {"doc_id": "test_doc_3", "hash": "ghi789", "last_seen": "2024-01-01T00:00:00"},
        }
        tracker.save()
