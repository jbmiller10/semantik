...
async def process_file_async(file_path: str, output_dir: str, embedding_service: EmbeddingService, args) -> Optional[str]:
...
async def main_async(args):
    ...
    try:
        ...
        results = await process_files_parallel(input_files, args.output, embedding_service, args)
