"""Add agent sessions tables for LLM agent conversation persistence.

Creates tables for storing agent conversation sessions:
- agent_sessions: Session metadata, configuration, and statistics
- agent_session_messages: Denormalized messages for efficient querying

Revision ID: 202601071000
Revises: 202601061001
...
revision: str = "202601071000"
down_revision: str | Sequence[str] | None = "202601061001"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None


def upgrade() -> None:
    """Create agent sessions tables."""
