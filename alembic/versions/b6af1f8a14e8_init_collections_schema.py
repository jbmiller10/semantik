...
def upgrade() -> None:
    ...
    op.create_index('ix_collection_permissions_unique_user', 'collection_permissions', ['collection_id', 'user_id'], unique=True, postgresql_where=sa.text('user_id IS NOT NULL'))
    op.create_index('ix_collection_permissions_unique_api_key', 'collection_permissions', ['collection_id', 'api_key_id'], unique=True, postgresql_where=sa.text('api_key_id IS NOT NULL'))
